...
Merge sort is a popular divide-and-conquer sorting algorithm that divides the input array into smaller halves, 
...
Recursively sort each half separately by applying the merge sort algorithm.
